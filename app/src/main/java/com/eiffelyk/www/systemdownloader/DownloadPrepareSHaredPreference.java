 ...
 */
public class DownloadPrepareSHaredPreference {
    ...
    private static DownloadPrepareSHaredPreference instance;
    private SharedPreferences sharedPreferences;


    private DownloadPrepareSHaredPreference(Context context) {
        initSpManager(context);
    }

    public static DownloadPrepareSHaredPreference getInstance(Context context) {
        synchronized (DownloadPrepareSHaredPreference.class) {
            if (instance == null) {
                synchronized (DownloadPrepareSHaredPreference.class) {
                    if (instance == null) {
                        instance = new DownloadPrepareSHaredPreference(context);
                    }
                }
            }
        }
