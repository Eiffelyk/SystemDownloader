 ...
 */
public class DownloadedSHaredPreference {
    ...
    private static DownloadedSHaredPreference instance;
    private SharedPreferences sharedPreferences;


    private DownloadedSHaredPreference(Context context) {
        initSpManager(context);
    }

    public static DownloadedSHaredPreference getInstance(Context context) {
        synchronized (DownloadedSHaredPreference.class) {
            if (instance == null) {
                synchronized (DownloadedSHaredPreference.class) {
                    if (instance == null) {
                        instance = new DownloadedSHaredPreference(context);
                    }
                }
            }
        }
